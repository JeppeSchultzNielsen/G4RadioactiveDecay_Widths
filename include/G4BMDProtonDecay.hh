...
#ifndef G4BMDProtonDecay_h
#define G4BMDProtonDecay_h 1
...
class G4BMDProtonDecay : public G4NuclearDecay
{
public:
    G4BMDProtonDecay(const G4ParticleDefinition* theParentNucleus,
